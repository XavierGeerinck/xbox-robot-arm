...
class GameController {
  constructor(signalPollIntervalMs = 50) {
    this.eventEmitter = new EventEmitter();
    this.SIGNAL_POLL_INTERVAL_MS = signalPollIntervalMs; // How quickly do we want data to come in?
    this.THUMBSTICK_NOISE_THRESHOLD = 0.15; // When do we say a thumbstick moved?
  }
